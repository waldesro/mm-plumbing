...
const SEO = {
  ...
  description:
    "Licensed local plumber serving St. Charles, St. Peters, O’Fallon, Wentzville & St. Louis County. Drain cleaning, water heaters, sewer repair & emergency plumbing. Call (314) 276-8617.",
...
export default function MMPlumbing() {
  ...
  // LocalBusiness / Plumber schema (kept stable via memo)
  const schemaPlumber = useMemo(
    () => ({
      "@context": "https://schema.org",
      "@type": "Plumber",
      name: BRAND.name,
      url: `${SEO.domain}${SEO.canonicalPath}`,
      telephone: BRAND.phoneTel,
      email: BRAND.email,
      areaServed: BRAND.serviceAreas.map((name) => ({
        "@type": "Place",
        name,
        address: { "@type": "PostalAddress", addressRegion: "MO" },
      })),
      serviceType: [
        "Plumbing Repair",
        "Drain Cleaning",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${SEO.domain}${SEO.canonicalPath}`} />
        ...
        <meta property="og:url" content={`${SEO.domain}${SEO.canonicalPath}`} />
        ...
        <script type="application/ld+json">{JSON.stringify(schemaPlumber)}</script>
      </Helmet>
          ...
          >
            ...
            <img
              ...
              className={[
                ...
                scrolledPastHeroTop ? "h-14 sm:h-16" : "h-20 sm:h-24 md:h-28",
              ].join(" ")}
            />
            ...
            <div className="mx-auto max-w-6xl py-8">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-slate-600">
                  ...
                  From urgent repairs to installations, we deliver honest pricing, quality workmanship, and service
          ...
          <div className="max-w-6xl mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 space-y-4 text-slate-700 leading-relaxed">
                <p>
                  At {BRAND.name}, we believe great plumbing starts with doing things the right way. We approach every
                  home and business with care, professionalism, and attention to detail—from the first call to the final
                  walkthrough.
                </p>

                <p>
                  Our services are built on accurate diagnostics, upfront recommendations, and quality workmanship you
                  can trust. Whether it’s a small repair, routine maintenance, or a more complex plumbing issue, we focus
                  on long-term solutions—not shortcuts.
                </p>

                <p className="italic text-slate-600">
                  Our goal is simple: show up on time, communicate clearly, and leave your plumbing system working exactly
                  as it should.
                </p>
              </div>
