...
import Services, { services as SERVICES } from "@/components/Services";
...
const SEO = {
    ...
    description:
        "Trusted plumbing services in " + BRAND.serviceAreas.join(", ") + ". Including: " + SERVICES.flatMap((s) => s.items).slice(0, 3).join(", ") + ".",
    ...
    const schemaPlumber = useMemo(
        () => ({
            ...
            areaServed: BRAND.serviceAreas.map((name) => ({
                "@type": "Place",
                name,
                address: { "@type": "PostalAddress", addressRegion: BRAND.serviceRegion },
            })),
